...
def run_export():
    ...
    output_file_parquet = PROJECT_ROOT / "data" / "processed" / "sentiment_fav.parquet"
    output_file_excel = PROJECT_ROOT / "data" / "processed" / "sentiment_fav.xlsx"
    output_file_csv = PROJECT_ROOT / "data" / "processed" / "sentiment_fav.csv"
